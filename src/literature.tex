...
The current version can simulate up to a speed of 12\thinspace500 warp instructions per second, which still improves upon the previous GPGPU-Sim version.
