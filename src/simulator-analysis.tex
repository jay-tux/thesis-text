...
We set up AccelSim to use the existing, tested configurations for the NVIDIA GeForce RTX 3070 hardware (SM 86). % TODO: add cache size?
...
\begin{figure}[ht]
    \centering
    \resizebox{0.45\textwidth}{!}{\input{figures/simulated/ocean_kernels}}
