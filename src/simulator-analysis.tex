\chapter{The Cold-Start Problem in AccelSim}\label{~\cite}
...
%The OceanFFT will prove to not be very promising, having the ``problematic'' kernel as second kernel chronologically, limiting our analysis of