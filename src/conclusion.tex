...
\begin{figure}[ht]
    \centering
    \appendCW{figures/hardware/mlperf_cactus_boxplot.pgf}{Unweighted impact}{fig:concl-unw-hw}{0.45}
    \appendCW{figures/hardware/mlperf_cactus_weight.pgf}{Weighted impact}{fig:concl-w-hw}{0.45}
...
\begin{figure}[h]
    \centering
    \appendW{figures/simulated/full_dct_ocean_unet_sim.pgf}{0.45}
...
\begin{figure}[hb]
    \centering
    \appendW{figures/simulated/kernel-11-acc.pgf}{0.45}
    \appendW{figures/simulated/kernel-13-acc.pgf}{0.45}
    \appendW{figures/simulated/kernel-114-acc.pgf}{0.45}
    \appendW{figures/simulated/kernel-115-acc.pgf}{0.45}
