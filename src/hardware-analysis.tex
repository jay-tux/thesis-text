...
\begin{figure}
    \centering
    \append{./figures/hardware/mlperf_cactus_boxplot.pgf}
    \append{./figures/hardware/dct_ocean_boxplot.pgf}
...
\begin{figure}[ht]
    \centering
    \append{figures/hardware/mlperf_cactus_weight.pgf}
    \append{figures/hardware/table_mlperf_cactus}
    \caption{Weighted IPC differences for MLPerf and Cactus}
    \label{fig:weight_ipc_diff}
\end{figure}
\begin{figure}[htb]
    \centering
    \append{figures/hardware/dct_ocean.pgf}
    \append{figures/hardware/table_dct_ocean}
...
\begin{figure}[htb]
    \centering
    \appendCW{./figures/hardware/dct_forward_reuse.pgf}{Forward data reuse}{fig:dct_forward_reuse}{0.6}
    \appendCW{./figures/hardware/dct_backward_reuse.pgf}{Backward data reuse}{fig:dct_backward_reuse}{0.6}
...
\begin{figure}[hbt]
    \centering
    \appendCW{./figures/hardware/recg_forward_reuse.pgf}{Forward data reuse}{fig:recg_forward_reuse}{0.6}
    \appendCW{./figures/hardware/recg_backward_reuse.pgf}{Backward data reuse}{fig:recg_backward_reuse}{0.6}
